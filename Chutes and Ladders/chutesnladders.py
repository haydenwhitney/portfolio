...
class Board(object):
    ...
    def create_space(self):
        empty_space = Space(0)
        for i in range(100):
            self.board.append(empty_space)
        space_1 = Space(37)
        self.board[0] = space_1
        space_4 = Space(10)
        self.board[3] = space_4
        space_9 = Space(21)
        self.board[9] = space_9
        space_16 = Space(-10)
        self.board[15] = space_16
        space_21 = Space(11)
        self.board[20] = space_21
        space_28 = Space(64)
        self.board[27] = space_28
        space_51 = Space(13)
        self.board[50] = space_51
        space_56 = Space(-3)
        self.board[55] = space_56
        space_62 = Space(-43)
        self.board[61] = space_62
        space_64 = Space(-4)
        self.board[63] = space_64
        space_71 = Space(11)
        self.board[70] = space_71
        space_80 = Space(20)
        self.board[79] = space_80
        space_87 = Space(-63)
        self.board[86] = space_87
        space_93 = Space(-20)
        self.board[92] = space_93
        space_95 = Space(-20)
        self.board[94] = space_95
        space_98 = Space(-20)
        self.board[97] = space_98
...
def switch_turn(number_of_players, turn):
    turn = turn
...
def congrat_winner():
    print("Congratulations! You beat the rest of these scumbags.")


def main():
    number_of_players = input_number("How many players will be playing? ", 2, 4)
    players = []
    turn = 0
    winner = None
    ...
    while not winner:
        ...
        players[turn].move()
        player_position = players[turn].position
        space = board.board[player_position]
        space.move_player(players[turn], board)
        winner = players[turn].win()
        if not winner:
            turn = switch_turn(number_of_players, turn)
    congrat_winner()
    print(winner)
